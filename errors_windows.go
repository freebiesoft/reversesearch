...
// NoLogEntriesInFile is returned when LeStartPattern stops matching beyond a certain
...
// NoMoreLogEntries is returned when no log entries are detected in the log file
